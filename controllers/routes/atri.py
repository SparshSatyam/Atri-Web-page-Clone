...
class Atri:
	...
	@property
	def Overlay9(self):
		self._getter_access_tracker["Overlay9"] = {}
		return self._Overlay9
	@Overlay9.setter
	def Overlay9(self, new_state):
		self._setter_access_tracker["Overlay9"] = {}
		global default_state
		self._Overlay9 = Overlay(new_state, default_state["Overlay9"])
